...
Centralize authorization, risk classification, policy checks and fail-closed behavior.
...
AI cannot modify policy, grant itself permission or bypass checks.
...
Unauthorized/high-risk/blocked operations are denied or require explicit confirmation.
