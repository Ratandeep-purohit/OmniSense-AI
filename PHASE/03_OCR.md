...
Extract screen text with coordinates and confidence while keeping OCR behind a replaceable interface.
...
A1[Preprocess]
A2[OCR]
A3[Text + Bounding Boxes + Confidence]
A0 --> A1
A1 --> A2
A2 --> A3
```
...
No action execution or autonomous interpretation.
...
OCR reliably returns structured text observations and handles failures.
