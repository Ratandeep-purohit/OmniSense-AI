...
Identify active windows, applications, titles, geometry and monitor association.
...
No UI automation or destructive actions.
...
Current application/window context is detected with graceful fallback.
