...
Prepare frames for downstream perception through validation, resizing, cropping, normalization and change detection.
...
No OCR, AI reasoning or automation.
...
Valid processed frames and deterministic region extraction are available.
