...
Add provider-neutral multimodal reasoning with structured inputs/outputs and controlled data transmission.
...
```mermaid
flowchart LR
A0[Context + Visual Evidence + User Query]
A1[AI Interface]
A2[VLM/LLM]
A3[Structured Response]
A0 --> A1
A1 --> A2
A2 --> A3
```
...
AI output is untrusted; never bypass security boundaries.
...
Provider abstraction, prompt/context builder, parser and failure handling work.
