...
Verify real-world UI state after execution instead of trusting command completion.
...
Important actions produce verified success/failure and safe recovery.
