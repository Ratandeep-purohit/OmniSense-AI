...
Execute only permitted, validated desktop actions through controlled adapters.
...
No arbitrary shell/code execution, privilege escalation or covert surveillance.
...
Safe actions execute with cancellation, timeouts and cleanup.
