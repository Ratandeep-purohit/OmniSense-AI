...
Reliable, controllable monitor and region capture with lifecycle controls and metadata.
...
```mermaid
flowchart LR
A0[Monitor Detection]
A1[Capture]
A2[Validation]
A3[Metadata]
A4[Start/Stop/Pause/Resume]
A0 --> A1
A1 --> A2
A2 --> A3
A3 --> A4
...
No AI interpretation, permanent recording or automation.
...
Selected monitors/regions capture correctly and failures are handled safely.
