...
**Phase 18 engineering rule:** build deeply, keep authority narrow, verify boundaries, and leave reproducible evidence## Phase-Specific Engineering Contract

**Primary objective:** Create reproducible, secure, versioned release artifacts with installation, upgrade, configuration validation, smoke tests, diagnostics, integrity checks, rollback and release evidence.

### Mandatory responsibilities

- **P18-SPEC-001: The implementation MUST define, validate, observe, test and document requirement 1 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-002: The implementation MUST define, validate, observe, test and document requirement 2 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-003: The implementation MUST define, validate, observe, test and document requirement 3 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-004: The implementation MUST define, validate, observe, test and document requirement 4 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-005: The implementation MUST define, validate, observe, test and document requirement 5 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-006: The implementation MUST define, validate, observe, test and document requirement 6 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-007: The implementation MUST define, validate, observe, test and document requirement 7 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-008: The implementation MUST define, validate, observe, test and document requirement 8 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-009: The implementation MUST define, validate, observe, test and document requirement 9 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-010: The implementation MUST define, validate, observe, test and document requirement 10 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-011: The implementation MUST define, validate, observe, test and document requirement 11 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-012: The implementation MUST define, validate, observe, test and document requirement 12 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-013: The implementation MUST define, validate, observe, test and document requirement 13 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-014: The implementation MUST define, validate, observe, test and document requirement 14 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-015: The implementation MUST define, validate, observe, test and document requirement 15 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-016: The implementation MUST define, validate, observe, test and document requirement 16 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-017: The implementation MUST define, validate, observe, test and document requirement 17 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-018: The implementation MUST define, validate, observe, test and document requirement 18 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-019: The implementation MUST define, validate, observe, test and document requirement 19 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-020: The implementation MUST define, validate, observe, test and document requirement 20 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-021: The implementation MUST define, validate, observe, test and document requirement 21 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-022: The implementation MUST define, validate, observe, test and document requirement 22 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-023: The implementation MUST define, validate, observe, test and document requirement 23 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-024: The implementation MUST define, validate, observe, test and document requirement 24 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-025: The implementation MUST define, validate, observe, test and document requirement 25 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-026: The implementation MUST define, validate, observe, test and document requirement 26 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-027: The implementation MUST define, validate, observe, test and document requirement 27 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-028: The implementation MUST define, validate, observe, test and document requirement 28 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-029: The implementation MUST define, validate, observe, test and document requirement 29 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-030: The implementation MUST define, validate, observe, test and document requirement 30 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-031: The implementation MUST define, validate, observe, test and document requirement 31 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-032: The implementation MUST define, validate, observe, test and document requirement 32 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-033: The implementation MUST define, validate, observe, test and document requirement 33 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-034: The implementation MUST define, validate, observe, test and document requirement 34 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-035: The implementation MUST define, validate, observe, test and document requirement 35 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-036: The implementation MUST define, validate, observe, test and document requirement 36 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-037: The implementation MUST define, validate, observe, test and document requirement 37 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-038: The implementation MUST define, validate, observe, test and document requirement 38 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-039: The implementation MUST define, validate, observe, test and document requirement 39 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-040: The implementation MUST define, validate, observe, test and document requirement 40 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-041: The implementation MUST define, validate, observe, test and document requirement 41 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-042: The implementation MUST define, validate, observe, test and document requirement 42 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-043: The implementation MUST define, validate, observe, test and document requirement 43 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-044: The implementation MUST define, validate, observe, test and document requirement 44 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-045: The implementation MUST define, validate, observe, test and document requirement 45 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-046: The implementation MUST define, validate, observe, test and document requirement 46 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-047: The implementation MUST define, validate, observe, test and document requirement 47 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-048: The implementation MUST define, validate, observe, test and document requirement 48 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-049: The implementation MUST define, validate, observe, test and document requirement 49 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-050: The implementation MUST define, validate, observe, test and document requirement 50 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-051: The implementation MUST define, validate, observe, test and document requirement 51 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-052: The implementation MUST define, validate, observe, test and document requirement 52 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-053: The implementation MUST define, validate, observe, test and document requirement 53 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-054: The implementation MUST define, validate, observe, test and document requirement 54 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-055: The implementation MUST define, validate, observe, test and document requirement 55 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-056: The implementation MUST define, validate, observe, test and document requirement 56 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-057: The implementation MUST define, validate, observe, test and document requirement 57 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-058: The implementation MUST define, validate, observe, test and document requirement 58 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-059: The implementation MUST define, validate, observe, test and document requirement 59 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-060: The implementation MUST define, validate, observe, test and document requirement 60 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-061: The implementation MUST define, validate, observe, test and document requirement 61 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-062: The implementation MUST define, validate, observe, test and document requirement 62 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-063: The implementation MUST define, validate, observe, test and document requirement 63 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-064: The implementation MUST define, validate, observe, test and document requirement 64 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-065: The implementation MUST define, validate, observe, test and document requirement 65 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-066: The implementation MUST define, validate, observe, test and document requirement 66 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-067: The implementation MUST define, validate, observe, test and document requirement 67 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-068: The implementation MUST define, validate, observe, test and document requirement 68 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-069: The implementation MUST define, validate, observe, test and document requirement 69 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-070: The implementation MUST define, validate, observe, test and document requirement 70 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-071: The implementation MUST define, validate, observe, test and document requirement 71 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-072: The implementation MUST define, validate, observe, test and document requirement 72 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-073: The implementation MUST define, validate, observe, test and document requirement 73 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-074: The implementation MUST define, validate, observe, test and document requirement 74 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-075: The implementation MUST define, validate, observe, test and document requirement 75 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-076: The implementation MUST define, validate, observe, test and document requirement 76 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-077: The implementation MUST define, validate, observe, test and document requirement 77 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-078: The implementation MUST define, validate, observe, test and document requirement 78 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-079: The implementation MUST define, validate, observe, test and document requirement 79 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-080: The implementation MUST define, validate, observe, test and document requirement 80 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-081: The implementation MUST define, validate, observe, test and document requirement 81 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-082: The implementation MUST define, validate, observe, test and document requirement 82 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-083: The implementation MUST define, validate, observe, test and document requirement 83 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-084: The implementation MUST define, validate, observe, test and document requirement 84 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-085: The implementation MUST define, validate, observe, test and document requirement 85 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-086: The implementation MUST define, validate, observe, test and document requirement 86 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-087: The implementation MUST define, validate, observe, test and document requirement 87 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-088: The implementation MUST define, validate, observe, test and document requirement 88 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-089: The implementation MUST define, validate, observe, test and document requirement 89 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-090: The implementation MUST define, validate, observe, test and document requirement 90 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-091: The implementation MUST define, validate, observe, test and document requirement 91 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-092: The implementation MUST define, validate, observe, test and document requirement 92 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-093: The implementation MUST define, validate, observe, test and document requirement 93 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-094: The implementation MUST define, validate, observe, test and document requirement 94 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-095: The implementation MUST define, validate, observe, test and document requirement 95 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-096: The implementation MUST define, validate, observe, test and document requirement 96 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-097: The implementation MUST define, validate, observe, test and document requirement 97 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-098: The implementation MUST define, validate, observe, test and document requirement 98 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-099: The implementation MUST define, validate, observe, test and document requirement 99 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-100: The implementation MUST define, validate, observe, test and document requirement 100 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-101: The implementation MUST define, validate, observe, test and document requirement 101 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-102: The implementation MUST define, validate, observe, test and document requirement 102 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-103: The implementation MUST define, validate, observe, test and document requirement 103 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-104: The implementation MUST define, validate, observe, test and document requirement 104 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-105: The implementation MUST define, validate, observe, test and document requirement 105 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-106: The implementation MUST define, validate, observe, test and document requirement 106 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-107: The implementation MUST define, validate, observe, test and document requirement 107 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-108: The implementation MUST define, validate, observe, test and document requirement 108 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-109: The implementation MUST define, validate, observe, test and document requirement 109 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-110: The implementation MUST define, validate, observe, test and document requirement 110 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-111: The implementation MUST define, validate, observe, test and document requirement 111 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-112: The implementation MUST define, validate, observe, test and document requirement 112 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-113: The implementation MUST define, validate, observe, test and document requirement 113 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-114: The implementation MUST define, validate, observe, test and document requirement 114 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-115: The implementation MUST define, validate, observe, test and document requirement 115 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-116: The implementation MUST define, validate, observe, test and document requirement 116 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-117: The implementation MUST define, validate, observe, test and document requirement 117 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-118: The implementation MUST define, validate, observe, test and document requirement 118 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-119: The implementation MUST define, validate, observe, test and document requirement 119 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
- **P18-SPEC-120: The implementation MUST define, validate, observe, test and document requirement 120 for this phase. It MUST remain inside the phase boundary, preserve provenance, handle failure explicitly, release resources, and never create an undocumented authority path.
